...
import 'package:userprogram/viewmodel/monthly_viewmodel.dart';

import '../../../model/home_good/onchain_bean.dart';

List<OnChainGood> monthlyRankList = [
  OnChainGood(
...
class _ChartsPage3State extends State<ChartsPage3> {
  GetMonthlyRankViewModel getMonthlyRankViewModel = GetMonthlyRankViewModel();
  @override
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          children: [
            AppBar(
              title: Text('Monthly',style: TextStyle(color: Color(0xFFD9AAFF),fontSize: 48,fontWeight: FontWeight.bold),),
            ...
            Expanded(
                child: Container(
                  ...
                  child: CustomScrollView(
                    slivers: [
                      FutureBuilder(
                          future:getMonthlyRankViewModel.getMonthlyRank(),
                          builder:(BuildContext context,AsyncSnapshot asyncSnapshot) {
                            if(true){
                              debugPrint('done');
                              var dailyGoods=monthlyRankList;
                              return SliverList(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text(product.name!,style: TextStyle(color: Colors.white,fontSize: 12.rpx),),
                                              ...
                                              Text(product.hotValue.toString(),style: TextStyle(fontSize: 12,color: Colors.white),),
