...
import 'package:userprogram/viewmodel/daily_viewmodel.dart';
...
class _ChartsPageState extends State<ChartsPage> {
  ...
  GetDailyRankViewModel getDailyRankViewModel = GetDailyRankViewModel();
  @override
  Widget build(BuildContext context) {
    ...
    fit: BoxFit.cover, // 适应容器大小，可以根据需求调整
        ...
        child: Column(
          children: [
            AppBar(
              title: Text('Daily',style: TextStyle(color: Color(0xFFD9AAFF),fontSize: 48,fontWeight: FontWeight.bold),),
            ...
            Expanded(
                child: Container(
                  ...
                  child: CustomScrollView(
                    slivers: [
                      FutureBuilder(
                      future:getDailyRankViewModel.getdailyRank(),
                      builder:(BuildContext context,AsyncSnapshot asyncSnapshot) {
                      if(true){
                        debugPrint('done');
                        var dailyGoods=dailyRankList;
                        return SliverList(
                                        ...
                                        Expanded(child: Column(
                                          ...
                                          children: [
                                            ...
                                            Container(width: 160.rpx,
                                              child:
                                              Text(product.description!,style: TextStyle(color: Colors.white,fontSize: 10),
